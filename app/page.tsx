          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {guides.map((guide) => {
                ...
                return (
                  <DraggableCard key={guide.href} defaultWidth={550} defaultHeight={280}>
                    <Link
                      href={guide.href}
                      className="group relative overflow-hidden rounded-xl border border-border bg-card h-full flex flex-col p-6 sm:p-8 hover:border-primary/50 transition-all duration-300"
                    >
                      {/* Background gradient */}
                      <div
